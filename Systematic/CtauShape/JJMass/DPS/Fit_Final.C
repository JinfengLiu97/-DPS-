//Jinfeng, 25.09.25
//Fitter to calculate the uncertainty from the ctau shape [M(JJ),DPS]
...
void Fit_Final(float FourMuonMass_LowCut_Value, float FourMuonMass_HighCut_Value, int MassNumber, float Standard_Value, TString Output_Name) {
	...
	float ctau_JJ_Gaus_Sigma1_Value = 0.00231;
	float ctau_JJ_Gaus_Sigma2_Value = 0.0064;
	float ctau_JJ_Gaus_Frac_Value = 0.80;
