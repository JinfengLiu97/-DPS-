//Jinfeng, 25.09.25
//Fitter to calculate the uncertainty from the fix of parameters [M(JJ),PDF4]
// 
// H1. T Series
#include "TString.h"
#include "TH2.h"
...
void Fit_Final(float FourMuonMass_LowCut_Value, float FourMuonMass_HighCut_Value, int MassNumber, float Standard_Value, TString Output_Name) {
	...
	RooRealVar ctau_JMuMu_MuMu_Convolution_Tau("ctau_JMuMu_MuMu_Convolution_Tau", "ctau_JMuMu_MuMu_Convolution_Tau", ctau_JMuMu_MuMu_Convolution_Tau_Value, ctau_JMuMu_MuMu_Convolution_Tau_Value * 1.2, ctau_JMuMu_MuMu_Convolution_Tau_Value * 0.8);

	RooRealVar ctau_JMuMu_MuMu_Convolution_Mean("ctau_JMuMu_MuMu_Convolution_Mean", "ctau_JMuMu_MuMu_Convolution_Mean", ctau_JMuMu_MuMu_Convolution_Mean_Value, ctau_JMuMu_MuMu_Convolution_Mean_Value * 0.8, ctau_JMuMu_MuMu_Convolution_Mean_Value * 1.2);
	RooRealVar ctau_JMuMu_MuMu_Convolution_Sigma("ctau_JMuMu_MuMu_Convolution_Sigma", "ctau_JMuMu_MuMu_Convolution_Sigma", ctau_JMuMu_MuMu_Convolution_Sigma_Value, ctau_JMuMu_MuMu_Convolution_Sigma_Value * 0.8, ctau_JMuMu_MuMu_Convolution_Sigma_Value * 1.2);
