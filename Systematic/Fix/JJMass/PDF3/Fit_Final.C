//Jinfeng, 25.09.25
//Fitter to calculate the uncertainty from the fix of parameters [M(JJ),PDF3]
// 
// H1. T Series
#include "TString.h"
#include "TH2.h"
...
void Fit_Final(float FourMuonMass_LowCut_Value, float FourMuonMass_HighCut_Value, int MassNumber, float Standard_Value, TString Output_Name) {
	...
	RooRealVar ctau_JMuMu_J_Convolution_Tau("ctau_JMuMu_J_Convolution_Tau", "ctau_JMuMu_J_Convolution_Tau", ctau_JMuMu_J_Convolution_Tau_Value, ctau_JMuMu_J_Convolution_Tau_Value * 1.2, ctau_JMuMu_J_Convolution_Tau_Value * 0.8);

	RooRealVar ctau_JMuMu_J_Convolution_Mean("ctau_JMuMu_J_Convolution_Mean", "ctau_JMuMu_J_Convolution_Mean", ctau_JMuMu_J_Convolution_Mean_Value, ctau_JMuMu_J_Convolution_Mean_Value * 0.8, ctau_JMuMu_J_Convolution_Mean_Value * 1.2);
	RooRealVar ctau_JMuMu_J_Convolution_Sigma("ctau_JMuMu_J_Convolution_Sigma", "ctau_JMuMu_J_Convolution_Sigma", ctau_JMuMu_J_Convolution_Sigma_Value, ctau_JMuMu_J_Convolution_Sigma_Value * 0.8, ctau_JMuMu_J_Convolution_Sigma_Value * 1.2);

	RooRealVar ctau_JMuMu_J_Gaus_Mean("ctau_JMuMu_J_Gaus_Mean", "ctau_JMuMu_J_Gaus_Mean", ctau_JMuMu_J_Gaus_Mean_Value, ctau_JMuMu_J_Gaus_Mean_Value * 0.8, ctau_JMuMu_J_Gaus_Mean_Value * 1.2);
	RooRealVar ctau_JMuMu_J_Gaus_Sigma("ctau_JMuMu_J_Gaus_Sigma", "ctau_JMuMu_J_Gaus_Sigma", ctau_JMuMu_J_Gaus_Sigma_Value, ctau_JMuMu_J_Gaus_Sigma_Value * 0.8, ctau_JMuMu_J_Gaus_Sigma_Value * 1.2);

	RooRealVar ctau_JMuMu_J_Frac("ctau_JMuMu_J_Frac", "ctau_JMuMu_J_Frac", ctau_JMuMu_J_Frac_Value, ctau_JMuMu_J_Frac_Value * 0.8, ctau_JMuMu_J_Frac_Value * 1.2);
	...
	//Plot ctau1
	RooPlot* ctau1Frame = x1_.frame(Title("c#tau^{J/#psi1}"), Range(-0.05, 0.25));
	...
	RooPlot* ctau1_Pull_Frame = x1_.frame(Title(" "), Range(-0.05, 0.25));
	...
	//Plot ctau2
	RooPlot* ctau2Frame = x2_.frame(Title("c#tau^{J/#psi2}"), Range(-0.05, 0.25));
	...
	RooPlot* ctau2_Pull_Frame = x2_.frame(Title(" "), Range(-0.05, 0.25));
